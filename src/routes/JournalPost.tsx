  ...
  return (
    <>
      ...
      <section data-scene={2} className="px-5 md:px-10 pt-32 md:pt-44">
        <TLink
          to="/journal"
          className="font-mono text-[11px] uppercase tracking-[0.18em] text-bone/45 hover:text-bone transition-colors"
        >
          [ ← jurnal ]
        </TLink>
        ...
        <motion.h1
          ...
          className="mt-8 max-w-5xl font-sans font-semibold tracking-[-0.03em] leading-[0.95] text-[clamp(2.2rem,7vw,5.5rem)]"
        >
          {p.title}
        </motion.h1>
        ...
        <motion.div
          ...
          className="mt-6 flex flex-wrap items-center gap-x-6 gap-y-2 font-mono text-[11px] uppercase tracking-[0.18em] text-bone/50"
        >
          ...
          <div>
            {prev && (
              <TLink to={`/journal/${prev.slug}`} className="group block">
                ...
                <span className="block mt-3 font-sans font-medium tracking-tight leading-tight text-[clamp(1.2rem,3vw,2rem)] text-bone/70 group-hover:text-bone transition-colors">
                  {prev.title}
                </span>
              </TLink>
            )}
